      ...
      <Link to={`/${typeLink}/${id}`} >
        <div className="relative w-auto md:h-auto md:w-[234px] cursor-pointer lg:w-full xl:w-[95%] flex mr-[10px] lg:mx-[10px] rounded-md hover:scale-105 transition duration-[400ms] shadow-disney transform">
          ...
          <div className="bg-gradient-to-tl from-[#1e1f2a] to-[#30323e] rounded-md w-full">
            <picture>
              {!special && <source media="(min-width: 1022px)" srcSet={`https://image.tmdb.org/t/p/w500/${imageLG}`}></source>}
            <img
    ...
    return (
      <Link to={`/${typeLink}/${id}`} >
        <div className=".load-image relative cursor-pointer flex rounded-md hover:scale-105 transition duration-[400ms] shadow-disney transform">
          ...
          <div className="bg-gradient-to-tl from-[#1e1f2a] to-[#30323e] rounded-md w-full">
            <picture>
              <source media="(min-width: 1022px)" srcSet={`https://image.tmdb.org/t/p/w500/${imageLG}`}></source>
            <img
    ...
    return (
      <Link to={`/${typeLink}/${id}`} >
        <div className="md:my-4 px-4 md:p-[10px] rounded-lg relative flex items-center h-60 md:h-auto cursor-pointer">
          ...
          <img src={logo} alt="" className="logo-slider absolute md:h-[200px] md:left-16 md:object-cover hidden lg:block"/>
        </div>
      </Link>
    );
