import { AiFillHome, AiFillStar, AiOutlinePlus } from "react-icons/ai";
      ...
      <div className="profile px-4 flex items-center relative pr-5 text-[15px]">
        ...
        <div className="profile-active shadow-md">
          <header className="flex items-center mt-[85px] border-t-[1px] border-[#97979757] pr-4 w-full">
            <ul className="mt-6">
              <li className="my-[18px] text-[#b9b9b9] font-medium hover:text-white">
                <Link to={"/profile"}>Edit Profile</Link>
              </li>
              <li className="my-[18px] text-[#cacaca] font-medium hover:text-white">
